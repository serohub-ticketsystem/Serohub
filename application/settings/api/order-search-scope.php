<?php
/**
 * API für Suchbereich der Bestellungs-Suche (User-Einstellung).
 * Bestimmt, in welchen Feldern bei der Bestellungs-Suche gesucht wird.
 */
...
$allScopeKeys = [
    ...
    'company_name' => 'Firma',
    'device_name' => 'Gerät',
    'device_standort' => 'Gerätestandort',
    'device_hersteller' => 'Hersteller',
    'device_modell' => 'Modell',
    'device_seriennummer' => 'Seriennummer',
...
try {
    ...
    error_log("Order Search Scope API Error: " . $e->getMessage());
